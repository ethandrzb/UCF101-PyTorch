...
class InceptionI3d(nn.Module):
    def __init__(self, num_classes=157, spatial_squeeze=True, name='inception_i3d', in_channels=3,
        ...
        seq = [
            ('Conv3d_1a_7x7',
             Unit3D(in_channels=in_channels, output_channels=64, kernel_shape=[7, 7, 7], stride=(2, 2, 2),
                    padding=(3, 3, 3))),
        ...
        self.logits = Unit3D(in_channels=384 + 384 + 128 + 128, output_channels=self.num_classes,
                             kernel_shape=[1, 1, 1], padding=0, act=None, norm=None, use_bias=True)
